/* ══════════════════════════════════════════════════════════
   ThreatPilot AI — Pages Module (Enhanced v2)
...
function renderSettings() {
  ...
  container.innerHTML = `
    <div style="margin-bottom:16px;">
      ...
      <p style="font-size:11px;color:var(--text-muted);margin-top:2px;">ThreatPilot AI v16.4.7 · Logged in as ${userName} (${userRole})</p>
    </div>`;
