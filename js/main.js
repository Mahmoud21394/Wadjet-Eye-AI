...
function generateCustomerPDFReport(custId) {
  ...
  const win = window.open('', '_blank');
  if (win) {
    win.document.write(`<!DOCTYPE html><html><head><title>Wadjet-Eye — ${cust.name}</title>
    ...
    <div class="footer">Generated by Wadjet-Eye AI v16.4.7 · ${new Date().toISOString()} · CONFIDENTIAL</div>
