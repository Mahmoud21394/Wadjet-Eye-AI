/* ═══════════════════════════════════════════════════════════════════════════
   EYEbot AI — Platform Critical Fixes v22.0
   ─────────────────────────────────────────────────────────────────────────
...
(function () {
  ...
  function _renderBranding() {
    ...
    const S = window.BRANDING_STORE || {
      ...
      custom_domain: '',
      report_header: 'EYEbot AI — Confidential Threat Intelligence Report',
    };
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:18px;">
        ...
        <div style="background:#0d1117;border:1px solid #21262d;border-radius:10px;padding:20px;grid-column:1/-1;">
          ...
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px;">
            ...
            ${_brandField('brand-report-footer', 'Report Footer Text', S.report_footer || 'Generated by EYEbot AI · CONFIDENTIAL', 'text')}
          </div>
  ...
  function _fixWhatIfSimulator() {
    ...
    window._whatifExport = function () {
      ...
      const text = `EYEbot AI — What-If Simulation Export\nScenario: ${sim.label}\n\nPRE-EMPTIVE DEFENSES:\n${defenses.join('\n')}`;
  ...
  function _init() {
    ...
    const _domReady = () => {
      ...
      console.log('[v22] 🎯 All fixes applied — EYEbot AI v22.0 ready');
    };
